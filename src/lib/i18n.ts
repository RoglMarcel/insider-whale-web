...
const en = {
  ...
  "pf.rules.exitsValue": "Take profit +{tp}% · Stop loss −{sl}% · Trailing {trailDist}% below the highest close once +{trailArm}% · Time stop {hold} calendar days",
  "pf.rules.priority": "Priority when several break on the same day: stop loss → trailing → take profit → time.",
...
const de: Record<TKey, string> = {
  ...
  "pf.rules.exitsValue": "Take-Profit +{tp} % · Stop-Loss −{sl} % · Trailing {trailDist} % unter dem höchsten Schlusskurs ab +{trailArm} % · Zeit-Stop {hold} Kalendertage",
  "pf.rules.priority": "Reißen mehrere am selben Tag: Stop-Loss → Trailing → Take-Profit → Zeit.",
