...
const en = {
  ...
  "pf.headline.opensOn": "The book opens on {date}. It trades only signals that arrive from that day on, so there is nothing to draw before the first session settles.",
  "pf.action.sync": "Sync",
  ...
  "pf.chart.hint": "Both lines start on the same day at the same amount on one shared axis, so equal vertical distance means equal return. The shaded band is the gap between them — green where the portfolio is ahead of the S&P 500, red where it is behind. Triangles mark the sessions that traded; hover one for the tickers.",
  "pf.chart.difference": "Difference",
  "pf.chart.buy": "Buy",
  "pf.chart.sell": "Sell",
  "pf.chart.moreTrades": "+{n} more",
  "pf.range.7d": "7D",
  "pf.range.30d": "30D",
  "pf.range.90d": "90D",
  "pf.range.6m": "6M",
  ...
  "pf.price.stale": "Stale · {date}",
  "pf.price.unavailable": "Quote unavailable",
  "pf.col.price": "Price",
